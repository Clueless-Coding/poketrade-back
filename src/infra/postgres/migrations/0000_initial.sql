DO $$ BEGIN
 CREATE TYPE "trade_status" AS ENUM('PENDING', 'CANCELLED', 'ACCEPTED', 'REJECTED');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "trades_to_sender_items" ADD CONSTRAINT "trades_to_sender_items_sender_item_id_trades_id_fk" FOREIGN KEY ("sender_item_id") REFERENCES "trades"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "trades_to_receiver_items" ADD CONSTRAINT "trades_to_receiver_items_receiver_item_id_trades_id_fk" FOREIGN KEY ("receiver_item_id") REFERENCES "trades"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
